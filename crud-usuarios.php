...
if($bandera==1){
    $vericar_nombre="SELECT * from usuarios WHERE usuario='$nombre'";
    ...
    if(mysqli_num_rows($verificar_sql)>=1){
        ...
        $insertar= "INSERT INTO usuarios (id, usuario, email,pwd) VALUES 
    ...
    $estado_nombre="SELECT usuario from usuarios WHERE id=$id";
    ...
    $update_usuario= "UPDATE usuarios SET usuario= '$nombre', email='$usuario' where id=$id";
  ...
  $verificar_nuevo= "SELECT usuario FROM usuarios where usuario = '$nombre'";
