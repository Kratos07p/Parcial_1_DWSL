...
// Validar que se haya pasado el ID por GET
if (!isset($_GET['id'])) {
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Validar DUI único excepto para el registro actual
    ...
    <div class="card shadow-lg">
        <div class="card-body">
            ...
            <form action="" method="POST">
                ...
                <div class="mb-3">
                    <label class="form-label">Fotografía (ruta)</label>
                    <input type="text" name="fotografia" class="form-control" value="<?php echo $personal['fotografia']; ?>">
                </div>
